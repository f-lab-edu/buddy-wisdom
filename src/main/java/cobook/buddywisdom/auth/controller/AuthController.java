...
public class AuthController {
    ...
    // TODO : 외부 서버 redis 커넥션 오류로 추후 리팩토링 시 다시 추가할 예정
    // 현재는 쿠키로 진행

    private final AuthService authService;

    @PostMapping("/public/auth/login")
    public ResponseEntity<TokenDto> authorize(@Valid @RequestBody LoginRequestDto requestDto) throws NoSuchAlgorithmException {
