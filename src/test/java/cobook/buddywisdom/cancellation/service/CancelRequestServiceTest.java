...
import static cobook.buddywisdom.cancellation.vo.DirectionType.RECEIVED;
import static cobook.buddywisdom.cancellation.vo.DirectionType.SENT;
...
public class CancelRequestServiceTest {
	...
	class UpdateCancelRequestTest {
		...
		void when_confirmStatusIsTrue_expect_throwsConfirmedCancelRequestException() {
			...
			given(cancelRequestMapper.findById(anyLong())).willReturn(Optional.of(confirmedRequest));
